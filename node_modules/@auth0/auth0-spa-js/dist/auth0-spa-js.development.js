(function(global, factory) {
    ...
    const fetchWithWorker = async (fetchUrl, audience, scope, fetchOptions, timeout, worker, useFormData, useMrrt, skipTokenStorage) => sendMessage({
        type: "refresh",
        auth: {
            audience: audience,
            scope: scope
    ...
    const switchFetch = async function switchFetch(fetchUrl, audience, scope, fetchOptions, worker, useFormData) {
        ...
        if (worker) {
            return fetchWithWorker(fetchUrl, audience, scope, fetchOptions, timeout, worker, useFormData, useMrrt, skipTokenStorage);
        } else {
            return fetchWithoutWorker(fetchUrl, fetchOptions, timeout);
        }
    };
    async function getJSON(url, timeout, audience, scope, options, worker, useFormData, useMrrt, dpop, isDpopRetry, skipTokenStorage) {
        if (dpop) {
        ...
        for (let i = 0; i < DEFAULT_SILENT_TOKEN_RETRY_COUNT; i++) {
            try {
                response = await switchFetch(url, audience, scope, options, worker, useFormData, timeout, useMrrt, skipTokenStorage);
                fetchError = null;
                break;
            } catch (e) {
                fetchError = e;
        ...
        if (!ok) {
            ...
            if (error === "use_dpop_nonce") {
                ...
                return getJSON(url, timeout, audience, scope, options, worker, useFormData, useMrrt, dpop, true, skipTokenStorage);
            }
    ...
    async function oauthToken(_a, worker, skipTokenStorage) {
        var baseUrl = _a.baseUrl, timeout = _a.timeout, audience = _a.audience, scope = _a.scope, auth0Client = _a.auth0Client, useFormData = _a.useFormData, useMrrt = _a.useMrrt, dpop = _a.dpop, options = __rest(_a, [ "baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData", "useMrrt", "dpop" ]);
        ...
        }, worker, useFormData, useMrrt, isDpopSupported ? dpop : undefined, undefined, skipTokenStorage);
    }
    ...
    var WorkerFactory = createBase64WorkerFactory("", null, false);
    ...
    var _baseUrl, _clientId, _customFetch, _baseUrl2, _clientId2, _customFetch2, _grantRequest, _Class9_brand, _entries, _ttlMs, _maxEntries, _configuration, _serverMetadata, _clientAuthPromise, _options, _customFetch3, _jwks, _discoveryCache, _inFlightDiscovery, _jwksCache, _Class1_brand;
    ...
    _grantRequest = new WeakMap, _Class9_brand = new WeakSet, class PasskeyClient {
        constructor(options) {
        ...
        async register(options) {
            ...
            if (!response.ok) {
                const error = await _assertClassBrand(_Class9_brand, this, _parseErrorResponse).call(this, response);
        ...
        async getTokenByPasskey(options) {
            ...
            try {
                return await _classPrivateFieldGet2(_grantRequest, this).call(this, PASSKEY_GRANT_TYPE, params);
            } catch (e) {
                throw new PasskeyGetTokenError(e.error_description || "Failed to exchange passkey credential for tokens.", e);
            }
        }
    });
    ...
    function getTelemetryConfig(config) {
        ...
        return {
            ...
            version: (_config$version = config === null || config === void 0 ? void 0 : config.version) !== null && _config$version !== void 0 ? _config$version : "1.7.0"
        };
    }
    ...
    function appendExtraParams(params, extra) {
        if (!extra) return;
        for (const _ref3 of Object.entries(extra)) {
            var _ref4 = _slicedToArray(_ref3, 2);
            const parameterKey = _ref4[0];
            const parameterValue = _ref4[1];
    ...
    _options = new WeakMap, _customFetch3 = new WeakMap, _jwks = new WeakMap, _discoveryCache = new WeakMap, 
    _inFlightDiscovery = new WeakMap, _jwksCache = new WeakMap, _Class1_brand = new WeakSet, 
    class AuthClient {
        constructor(_options2) {
            var _options2$customFetch;
            _classPrivateMethodInitSpec(this, _Class1_brand);
            ...
            _classPrivateFieldSet2(_customFetch3, this, createTelemetryFetch((_options2$customFetch = _options2.customFetch) !== null && _options2$customFetch !== void 0 ? _options2$customFetch : function() {
                return fetch(...arguments);
            ...
            this.mfa = new MfaClient({
                ...
                customFetch: _classPrivateFieldGet2(_customFetch3, this)
            });
            this.passkey = new PasskeyClient({
                ...
                grantRequest: async (grantType, params) => {
                    const _await$_assertClassBr = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr.configuration;
        ...
        async getServerMetadata() {
            const _await$_assertClassBr2 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr2.serverMetadata;
            return serverMetadata;
        }
        async buildAuthorizationUrl(options) {
            const _await$_assertClassBr3 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr3.serverMetadata;
            ...
            try {
                return await _assertClassBrand(_Class1_brand, this, _buildAuthorizationUrl).call(this, options);
            } catch (e) {
        ...
        async buildLinkUserUrl(options) {
            try {
                const result = await _assertClassBrand(_Class1_brand, this, _buildAuthorizationUrl).call(this, {
        ...
        async backchannelAuthentication(options) {
            const _await$_assertClassBr4 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr4.configuration, serverMetadata = _await$_assertClassBr4.serverMetadata;
        ...
        async initiateBackchannelAuthentication(options) {
            const _await$_assertClassBr5 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr5.configuration, serverMetadata = _await$_assertClassBr5.serverMetadata;
            const additionalParams = stripUndefinedProperties(_objectSpread2(_objectSpread2({}, _classPrivateFieldGet2(_options, this).authorizationParams), options === null || options === void 0 ? void 0 : options.authorizationParams));
            const params = new URLSearchParams(_objectSpread2(_objectSpread2({
                scope: DEFAULT_SCOPES
            }, additionalParams), {}, {
        ...
        async backchannelAuthenticationGrant(_ref5) {
            let authReqId = _ref5.authReqId;
            const _await$_assertClassBr6 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr6.configuration;
            const params = new URLSearchParams({
        ...
        async exchangeToken(options) {
            return "connection" in options ? _assertClassBrand(_Class1_brand, this, _exchangeTokenVaultToken).call(this, options) : _assertClassBrand(_Class1_brand, this, _exchangeProfileToken).call(this, options);
        }
        async getTokenByCode(url, options) {
            const _await$_assertClassBr7 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr7.configuration;
            try {
        ...
        async getTokenByRefreshToken(options) {
            const _await$_assertClassBr8 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr8.configuration;
        ...
        async getTokenByPassword(options) {
            const _await$_assertClassBr9 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr9.configuration;
            const params = new URLSearchParams({
                username: options.username,
            ...
            if (options.auth0ForwardedFor) {
                const clientAuth = await _assertClassBrand(_Class1_brand, this, _getClientAuth).call(this);
                ...
                requestConfig[customFetch$1] = (url, init) => _classPrivateFieldGet2(_customFetch3, this).call(this, url, _objectSpread2(_objectSpread2({}, init), {}, {
        ...
        async getTokenByClientCredentials(options) {
            const _await$_assertClassBr0 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr0.configuration;
            try {
                const params = new URLSearchParams({
        ...
        async buildLogoutUrl(options) {
            const _await$_assertClassBr1 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr1.configuration, serverMetadata = _await$_assertClassBr1.serverMetadata;
        ...
        async verifyLogoutToken(options) {
            const _await$_assertClassBr10 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), serverMetadata = _await$_assertClassBr10.serverMetadata;
    ...
    async function _createConfiguration(serverMetadata) {
        ...
        configuration[customFetch$1] = _classPrivateFieldGet2(_customFetch3, this);
    ...
    async function _discover() {
        ...
        const cacheKey = _assertClassBrand(_Class1_brand, this, _getDiscoveryCacheKey).call(this);
        ...
        if (cached) {
            ...
            _classPrivateFieldSet2(_configuration, this, await _assertClassBrand(_Class1_brand, this, _createConfiguration).call(this, cached.serverMetadata));
            return {
                configuration: _classPrivateFieldGet2(_configuration, this),
                serverMetadata: _classPrivateFieldGet2(_serverMetadata, this)
            };
        ...
        if (inFlight) {
            ...
            _classPrivateFieldSet2(_configuration, this, await _assertClassBrand(_Class1_brand, this, _createConfiguration).call(this, entry.serverMetadata));
            return {
                configuration: _classPrivateFieldGet2(_configuration, this),
                serverMetadata: _classPrivateFieldGet2(_serverMetadata, this)
            };
        ...
        const discoveryPromise = (async () => {
            ...
            const configuration = await discovery(new URL("https://".concat(_classPrivateFieldGet2(_options, this).domain)), _classPrivateFieldGet2(_options, this).clientId, {
                ...
                [customFetch$1]: _classPrivateFieldGet2(_customFetch3, this)
            });
        ...
        const inFlightEntry = discoveryPromise.then(_ref6 => {
            let serverMetadata = _ref6.serverMetadata;
            return {
                serverMetadata: serverMetadata
            };
        });
        ...
        try {
            ...
            _classPrivateFieldGet2(_configuration, this)[customFetch$1] = _classPrivateFieldGet2(_customFetch3, this);
        } finally {
    ...
    async function _exchangeTokenVaultToken(options) {
        ...
        const _await$_assertClassBr11 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr11.configuration;
    ...
    async function _exchangeProfileToken(options) {
        const _await$_assertClassBr12 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr12.configuration;
        validateSubjectToken(options.subjectToken);
        const tokenRequestParams = new URLSearchParams({
    ...
    async function _buildAuthorizationUrl(options) {
        const _await$_assertClassBr13 = await _assertClassBrand(_Class1_brand, this, _discover).call(this), configuration = _await$_assertClassBr13.configuration;
    ...
    class Auth0Client {
        ...
        async customTokenExchange(options) {
            const result = await oauthToken(Object.assign(Object.assign({}, this._buildTokenExchangeParams(options)), {
                baseUrl: this.domainUrl,
                client_id: this.options.clientId,
                auth0Client: this.options.auth0Client,
                useFormData: this.options.useFormData,
